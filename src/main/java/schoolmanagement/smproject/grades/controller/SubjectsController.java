...
public class SubjectsController {
    ...
    @FXML
    private void handleMath() { navigateToGradeEntry("Mathematics"); }
    @FXML
    private void handleFrench() { navigateToGradeEntry("French"); }
    @FXML
    private void handleArabic() { navigateToGradeEntry("Arabic"); }
    @FXML
    private void handleEnglish() { navigateToGradeEntry("English"); }
    @FXML
    private void handleScience() { navigateToGradeEntry("Science"); }
    @FXML
    private void handleHistory() { navigateToGradeEntry("History"); }
