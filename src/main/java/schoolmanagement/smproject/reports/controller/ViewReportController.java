...
public class ViewReportController {
    ...
    private void exportToExcel(File file) throws IOException {
        ...
        titleRow.createCell(0).setCellValue(nullToEmpty(currentReport.getReportName()));
        ...
        Row contentHeader = sheet.createRow(5);
        contentHeader.createCell(0).setCellValue("Report Content:");
